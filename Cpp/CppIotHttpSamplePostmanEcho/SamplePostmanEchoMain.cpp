...
class CSamplePostmanEchoCtrl : public ITcOCFCtrlImpl<CSamplePostmanEchoCtrl, CSamplePostmanEchoClassFactory>
{
public:
...
{
	HRESULT hr = E_FAIL;
	TRACE("SamplePostmanEcho: DllGetTcCtrl(ITcCtrl** ppTcCtrl) \n");

	if (ppTcCtrl != NULL)
	{
		ITcCtrl* pTcCtrl = new IUnknownImpl<CSamplePostmanEchoCtrl>;
